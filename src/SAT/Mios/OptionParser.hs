...
miosDefaultOption = MiosProgramOption
  ...
  , _confRestartInitMode = restartInitMode defaultConfiguration
...
miosOptions =
  ...
  , Option [] ["Ri"]
    (NoArg (\c -> c { _confRestartInitMode = 1 }))
...
--                 , randomDecisionRate = _confRandomDecisionRate opts
                 ...
                 , restartInitMode = _confRestartInitMode opts
                 }
